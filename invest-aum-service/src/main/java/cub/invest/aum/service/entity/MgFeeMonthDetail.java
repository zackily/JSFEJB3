...
@Table(
		...
		uniqueConstraints = @UniqueConstraint(columnNames = { "TRUST_ACCT", "BASE_DATE" }))
public class MgFeeMonthDetail {
	/**
	 * ID
	 */
	@Id
	 ...
	 * 信託帳號
	 */
	@Column(name = "TRUST_ACCT", columnDefinition = "CHAR(12)")
	 ...
	 * 基金代碼
	 */
	@Column(name = "FUND_ID", columnDefinition = "CHAR(8)")
