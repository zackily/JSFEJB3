 ...
 */
@Stateless
public class EricMgFeeMonthDetailFacade extends AbstractFacade<EricMgFeeMonthDetail> {
    ...
    public EricMgFeeMonthDetailFacade() {
        super(EricMgFeeMonthDetail.class);
    }

    public List<EricMgFeeMonthDetail> findByQuery(String custId, Date startDate, Date endDate) {
        StringBuffer sql = new StringBuffer("SELECT efm FROM EricMgFeeMonthDetail efm WHERE 1 = 1 ");
